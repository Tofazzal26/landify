              ...
              <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="card-body items-center gap-3">
                    <div className="avatar avatar-placeholder">
                      <div className="border-primary/20 text-primary w-9 rounded-full border">
                        <FiClock className="text-green-800 size-6" />
                      </div>
                    </div>
                ...
                <div className="card shadow-none">
                  <div className="card-body items-center gap-3">
                    <div className="avatar avatar-placeholder">
                      <div className="border-primary/20 text-primary w-9 rounded-full border">
                        <IoLocationOutline className="size-6 text-green-800" />
                      </div>
                    </div>
                    <h4 className="text-base-content text-lg font-medium">
                      Our Address
                ...
                <div className="card shadow-none">
                  <div className="card-body items-center gap-3">
                    <div className="avatar avatar-placeholder">
                      <div className="border-primary/20 text-primary w-9 rounded-full border">
                        <IoCallOutline className="text-green-800 size-6" />
                      </div>
                    </div>
                    <h4 className="text-base-content text-lg font-medium">
                      Get in Touch
                    ...
                    <div className="text-center">
                      <p className="text-base-content/80">+880 1306-700357</p>
                      <p className="text-base-content/80">+880 1931-342951</p>
                    </div>
                  </div>
                </div>
              </div>
