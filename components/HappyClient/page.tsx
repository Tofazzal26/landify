      ...
      <div>
        <div>
          <div className="text-center lg:my-20 my-10">
            ...
            <h2 className="lg:text-5xl text-3xl font-semibold lg:my-4 my-2 lg:w-[600px] mx-auto lg:leading-[60px]">
              Winning hearts and trust. Customer
              <span className="text-[#295c51]">success stories</span>
            </h2>
            <p className="lg:text-lg text-sm text-[#69655b] lg:w-[550px] mx-auto">
          ...
          <div>
            <div>
              <section className="my-8">
                <div className="flex lg:flex-row md:flex-wrap flex-col items-center justify-center">
                  <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                    <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 ">
                      <p className="relative px-6 py-1 text-lg italic text-center text-gray-600">
                        <svg
                  ...
                  <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                    ...
                    <div className="flex flex-col items-center justify-center p-8 rounded-b-lg text-gray-900">
                      ...
                      <p className="text-sm uppercase text-gray-600 mt-1">
                        UX/UI
                      </p>
                    </div>
                  </div>
