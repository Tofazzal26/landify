      ...
      <section className="py-24 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="font-manrope text-4xl font-bold text-gray-900 text-center mb-16">
            Our latest <span className="text-[#e9bb71]">Resources</span>
          </h2>
          <div className="flex justify-center  gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
            <div className="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
              ...
              <div className="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-gray-50">
                <span className="text-[#295c51] font-medium mb-3 block">
                  Jan 01, 2023
                </span>
                ...
                <a
                  href="#"
                  className="cursor-pointer text-lg text-[#295c51] font-semibold"
                >
                  Read more..
                </a>
              </div>
